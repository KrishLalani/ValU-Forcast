...
router.post("/register", async (req, res) => {
  ...
  try {
    ...
    connection.query(query, [user_mail], async (err, results) => {
      ...
      const insertQuery =
        "INSERT INTO user (uid, username, user_mail, password, type, profile_img, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
      connection.query(
        insertQuery,
        [
          uid,
        ...
        (err, results) => {
          ...
          const userQuery =
            "SELECT uid, username, user_mail,type,profile_img FROM user WHERE uid = ?";
